            ...
            <div class="modal-dialog  modcolor">
                <div class="modal-content">
                    ...
                    <div class="modal-body modcolor">
                        <form role="form" id="logpost" action="">
                            <div class="form-group">
                                <label for="text">Логин</label>
                                <input type="text" class="form-control" id="logform" name="username" placeholder="Введите логин">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label><input type="checkbox" id="stayon"> Запомнить меня</label>
                            </div>
                             </form>
                            <button type="button" id='fsubmit' class="btn btn-success">Войти</button>
                            <button type="button" class="btn btn-info" onclick="location.href = 'register'">Регистрация</button>
                            <label id='wronginp'></label>
...
<div class="row">   <!--Колонка меню-->
  <div class="col-sm-12 col-md-12">
    <ul class="nav nav-tabs nav-menu topmenu">
...
<script type="text/javascript" src="<?php echo base_url("assets/js/jquery.colors-min.js"); ?>"></script>    
